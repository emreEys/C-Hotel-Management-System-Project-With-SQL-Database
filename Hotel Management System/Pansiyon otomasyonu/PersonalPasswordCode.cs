...
{
    public partial class PersonalPasswordCode : Form
    {
        public PersonalPasswordCode()
        {
            InitializeComponent();
        }
        ...
        private void PersonalPasswordCode_Load(object sender, EventArgs e)
        {
        ...
        private void BtnOkey_Click(object sender, EventArgs e)
        {
            if (TxtPasswprd1.Text != "" && TxtPassword2.Text != "")
            {
                ...
                if (TxtPasswprd1.Text == TxtPassword2.Text)
                {
                    SqlCommand cmd = new SqlCommand("Update tbl_Personal set PPass=@p1 where PUsername=@p2", con.bgl());
                    cmd.Parameters.AddWithValue("@p2", PersonalForgotPassword.username);
